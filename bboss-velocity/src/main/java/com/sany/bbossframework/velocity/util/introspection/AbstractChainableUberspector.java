package com.sany.bbossframework.velocity.util.introspection;
...
public abstract class AbstractChainableUberspector extends UberspectImpl implements ChainableUberspector
{
     ...
     * {@inheritDoc}
     * 
     * @see ChainableUberspector#wrap(bboss.org.apache.velocity.util.introspection.Uberspect)
     * @see #inner
     */
     ...
     * 
     * @see bboss.org.apache.velocity.util.introspection.Uberspect#init()
     */
    //@Override
    public void init()
    {
     ...
     * {@inheritDoc}
     * 
     * @see bboss.org.apache.velocity.util.introspection.Uberspect#getIterator(Object,
     ...
     * {@inheritDoc}
     * 
     * @see bboss.org.apache.velocity.util.introspection.Uberspect#getMethod(Object, String,
     *      Object[], bboss.org.apache.velocity.util.introspection.Info)
     */
    //@Override
     ...
     * {@inheritDoc}
     * 
     * @see bboss.org.apache.velocity.util.introspection.Uberspect#getPropertyGet(Object, String,
     *      bboss.org.apache.velocity.util.introspection.Info)
     */
    //@Override
     ...
     * {@inheritDoc}
     * 
     * @see bboss.org.apache.velocity.util.introspection.Uberspect#getPropertySet(Object, String,
     *      Object, bboss.org.apache.velocity.util.introspection.Info)
     */
    //@Override
