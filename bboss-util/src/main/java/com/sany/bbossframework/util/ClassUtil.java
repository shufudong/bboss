...
public class ClassUtils {
     ...
     *
     * @param name        the name of the Class
     * @param classLoader the class loader to use (may be <code>null</code>, which
     ...
     *
     * @param clazz       the class to analyse for interfaces
     * @param classLoader the ClassLoader that the interfaces need to be visible in (may
     ...
     * @param classLoader the ClassLoader to check against (may be <code>null</code>, in
