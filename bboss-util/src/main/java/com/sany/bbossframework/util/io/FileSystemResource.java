...
/**
 * <p>Title: FileSystemResource.java</p> 
 * <p>Description: </p>
 * <p>bboss workgroup</p>
 * <p>Copyright (c) 2007</p>
 * @Date 2010-9-24 下午10:17:11
 * @author biaoping.yin
 * @version 1.0
 */
public class FileSystemResource extends AbstractResource {
	...
	public FileSystemResource(File file) {
		...
		this.file = file;
		this.path = SimpleStringUtil.cleanPath(file.getPath());
	}
	 ...
	 * @see SimpleStringUtil#applyRelativePath(String, String)
	 */
